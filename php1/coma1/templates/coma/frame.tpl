   ...
   <table class="header">
    <tr>
     ...
     <td colspan="2" height="32" align="right" valign="top">
      ...
      <a href="{basepath}help.php?popup{&SID}" target="_blank"><img src="{path}images/info.gif" width="15" height="15" border="0" alt="Info"></a>
     </td>
    </tr>
    <tr>
...
<table class="footer">
 ...
 <tr>
  <td>&nbsp;</td>
  <td height="32">&copy; 2005 by Sandro Esquivel, Daniel Miesling, T&ouml;merich Scherzer, Falk Starke, Jan Waller</td>
