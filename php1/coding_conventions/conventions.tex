...
% ...
%\end{Verbatim}
\lstset{basicstyle=\footnotesize\ttfamily,language=PHP,numbers=left,stepnumber=0,tabsize=2,stringstyle=\emph,numberstyle=\tiny,numbersep=3pt,frame={},breaklines=true}
%% Headings
\usepackage{scrpage2}
\deftripstyle{ElveStyleUebung}[0pt][0.1pt]{Jan Waller - PHP Gruppe 1}{P-I-T-M - Guidelines}{\today}{}{\pagemark}{}
...
\AtBeginDocument{
  \begin{minipage}[b]{0.7\textwidth}
    \begin{center}
      ...
      Prof. Dr. W.-P. de Roever \\[2ex]
      Jan Waller - PHP Gruppe 1\\
    \end{center}
  \end{minipage}
  ...
  \noindent WS 2004/05\hfill\textbf{P-I-T-M - Guidelines}\hfill\today
