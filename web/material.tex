...
The \emph{versions} are those from \texttt{snert.}\footnote{Note that for
  the various java lib's there's a little confusions concerning the numbers
  (and file names) as some of the jar files which are offered for download
  at
  ...
  installation. Everything else invites trouble. }
