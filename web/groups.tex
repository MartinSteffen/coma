...
\begin{tabular}{|l|l|}
  ...
  \\
  web &\href{http://snert.informatik.uni-kiel.de:8080/~wprguest2}{(test/web) page}
\end{tabular}
...
\begin{tabular}{|l|l|}
  ...
  \\
  web &\href{http://snert.informatik.uni-kiel.de:8080/~wprguest3}{(test/web) page} for JCoMa
\end{tabular}
